    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'index.html',
                title: 'FalconMod - A mod of PenguinMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['fullscreen'],
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'embed.html',
                title: 'Embedded Project - FalconMod',
                noTheme: true,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                ...
                title: 'Addon Settings - FalconMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['credits'],
                ...
                title: 'FalconMod, PenguinMod & TurboWarp Credits',
                noSplash: true,
                ...htmlWebpackPluginCommon
            }),
